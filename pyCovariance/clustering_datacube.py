...
def sliding_window_parallel(
    ...
    # multiprocessing not working with apple silicon
    # TODO: fix this issue
    proc_arch_cond = platform.processor() != 'arm'
    n_jobs_cond = (n_jobs_rows > 1) or (n_jobs_columns > 1)
    if proc_arch_cond and n_jobs_cond:
        ...
        if platform.processor() == 'arm':
            warnings.warn('Multiprocessing has been disabled...')
