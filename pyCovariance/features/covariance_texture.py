...
from pymanopt.manifolds import SpecialHermitianPositiveDefinite
import warnings

from .base import Feature, make_feature_prototype
from ..manifolds import StrictlyPositiveVectors
...
def covariance_texture(weights=None, min_grad_norm_mean=1e-8, p=None, N=None):
