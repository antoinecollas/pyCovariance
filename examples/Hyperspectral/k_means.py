...
if __name__ == '__main__':
    ...
    # features_list = [PixelEuclidean(), MeanPixelEuclidean(), CovarianceEuclidean(), Covariance(), CovarianceTexture(p=NB_BANDS_TO_SELECT, N=WINDOWS_SHAPE[0]*WINDOWS_SHAPE[1])]
