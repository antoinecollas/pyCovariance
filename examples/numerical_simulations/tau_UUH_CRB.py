...
def main(n_points, n_MC, p, k, N_max_simu_U, N_simu_tau, verbose=True):
    ...
    for SNR in SNR_list:
        for var in var_list:
            ...
            features_list = [
                ...
                subspace_tau_UUH_RO(
                    k, estimate_sigma=False, information_geometry=True),
                subspace_tau_UUH_RO(
                    k, estimate_sigma=False, information_geometry=False)
            ]
            ...
            plt.loglog(list_n_points, mean_errors[2],
                       label='RO_IG', marker='2')
            plt.loglog(list_n_points, mean_errors[3], label='RO', marker='2')
    ...
    for var in var_list:
        ...
        plt.loglog(list_SNR, mean_errors[1], label='RO_IG', marker='2')
        plt.loglog(list_SNR, mean_errors[2], label='RO', marker='2')
